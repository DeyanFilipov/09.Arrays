...
public class LadyBugs_06 {
    public static void main(String[] args) {
        ...
        while (!"end".equals(move)) {
            ...
            int countMoves = Integer.parseInt(indexesToMove[2]);
            ...
            if (countMoves < 0) {
                if (direction.equals("left")) {
                    direction = "right";
                    countMoves = Math.abs(countMoves);
            ...
            if (initialPosition < 0 || initialPosition >= bugsArr.length || bugsArr[initialPosition] == 0) {
                ...
                continue;
            } else if (countMoves == 0 && initialPosition <= bugsArr.length - 1) {
            ...
            switch (direction) {
                case "right":
                    newPosition = initialPosition + countMoves;
                    bugsArr[initialPosition] = 0;
                    if (newPosition > bugsArr.length - 1) {
                        bugsArr[initialPosition] = 0;
                        break;
                    } else {
                        for (int i = newPosition; i < bugsArr.length; i+= countMoves) {
                            if (bugsArr[i] == 0) {
                                bugsArr[i] = 1;
                                break;
                            }
                ...
                case "left":
                    ...
                    if (newPosition < 0) {
                        ...
                        for (int i = newPosition; i >= 0 ;i-= countMoves) {
                            if (bugsArr[i] == 0) {
                                bugsArr[i] = 1;
                                break;
                            }
